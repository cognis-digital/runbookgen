#!/usr/bin/env sh
# Universal installer for runbookgen. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/runbookgen.git"
echo "Installing runbookgen ..."
