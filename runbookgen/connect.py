"""Native cognis-connect emit for runbookgen — forward findings to any platform.

Maps runbookgen's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    runbookgen ... --format json | runbookgen-emit --to stix
    runbookgen-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
