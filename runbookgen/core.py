"""RUNBOOKGEN core — Incident runbook and SOP generator from templates."""
...
RULES = [
    ("RUN-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("RUN-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("RUN-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
