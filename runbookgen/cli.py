"""RUNBOOKGEN command-line interface."""
from __future__ import annotations
import argparse, sys
from runbookgen.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="runbookgen", description="RUNBOOKGEN — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from runbookgen.mcp_server import serve
        return serve()
    if args.cmd == "scan":
