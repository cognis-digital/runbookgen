...
[![PyPI](https://img.shields.io/pypi/v/cognis-runbookgen.svg)](https://pypi.org/project/cognis-runbookgen/)
[![CI](https://github.com/cognis-digital/runbookgen/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/runbookgen/actions)
...
RUNBOOKGEN exists for one job — incident runbook and sop generator from templates — and does it without a SaaS bill or heavyweight setup.
...
```bash
runbookgen --version
runbookgen scan .                      # scan the current project
runbookgen scan . --format json
runbookgen scan . --fail-on high       # non-zero exit for CI gates
runbookgen mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Tettra**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`runbookgen` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
