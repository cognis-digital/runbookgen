...
- **rules/analyzers** apply the heuristics shipped in `runbookgen/core.py`.
- **score** ranks by severity.
- **MCP server** (`runbookgen mcp`) exposes `scan` for Cognis.Studio agents.
